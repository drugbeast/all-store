    ...
    <div className="flex flex-col min-h-screen font-montserrat">
      <header>
        <div className="container px-20 pt-5 flex justify-between">
          ...
          >
            ...
            <h1 className="text-4xl font-bold text-indigo-400 italic">
              All Store
            </h1>
          </NavLink>
      ...
      <footer className="flex-[0_0_auto] pb-5">
        <div className="container justify-center flex gap-5 items-center">
          <a href="https://github.com/drugbeast">
            <img src={githubIcon} alt="githubIcon" className="w-[35px]"></img>
          </a>
          <a href="https://rs.school/js/">
            <img src={courseLogo} alt="courseLogo" className="w-[80px]"></img>
          </a>
